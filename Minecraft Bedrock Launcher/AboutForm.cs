            ...
            try
            {
                ...
                using (MySqlConnection connection = new MySqlConnection("server=cloud.kamvdta.xyz;port=3306;database=doandat943;uid=phpmyadmin;password=kinhvanhoa000"))
                {
                    ...
                    if (command.ExecuteScalar() != null)
                    {
                        ...
                        command.CommandText = "UPDATE User_Logs SET app_version = @app_version, last_used = @date WHERE device_id = @device_id";
                        command.ExecuteNonQuery();
                    ...
                    else
                    {
                        ...
                        command.CommandText = "INSERT INTO User_Logs VALUES (@device_id, @app_id, @app_version, @date, @date)";
                        command.ExecuteNonQuery();
                    }
